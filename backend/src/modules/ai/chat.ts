...
export async function answerQuestion(message: string, history: ChatMessage[] = []): Promise<{
  ...
  const system = [
    ...
    '',
    'FORMATO OBRIGATÓRIO:',
    '- Texto puro, sem markdown: NÃO use tabelas, NÃO use "##", "###", "---", "**", "*", ">", nem "|".',
    '- Organize com títulos curtos em linha única (ex.: "Destaque:", "Como montar a posição:") seguidos de parágrafos.',
    '- Use listas simples com hífen (-) quando houver itens.',
    '- Seja conciso: no máximo 3-4 blocos de informação e, se citar vários ativos, escolha só os 1-2 mais relevantes.',
    '- Termine com uma conclusão prática de 1-2 linhas ("Em resumo: ...").',
    '',
